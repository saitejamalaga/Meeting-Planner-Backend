...
module.exports.setRouter = (app) => {
    ...
    */
    ...
    app.get(`${baseUrl}/view/all/meetings/:userId`, auth.isAuthorized, meetingController.getAllMeetings);
    /**
     * @apiGroup Meetings
     * @apiVersion  1.0.0
    ...
    */
    ...
    // params: meetingId.
    app.get(`${baseUrl}/:meetingId/details`, auth.isAuthorized, meetingController.getMeetingDetails);
    /**
     * @apiGroup Meetings
     * @apiVersion  1.0.0
